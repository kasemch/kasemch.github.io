...
function renderParticipants(list){
  ...
  list.forEach(p=>{
    ...
    if(approved){
      ...
      a.href=API_BASE+"/seminar-certificate-render?cert="+encodeURIComponent(cert.certificate_no)+"&token="+encodeURIComponent(cert.verification_token);actions.appendChild(a);
    }else{
